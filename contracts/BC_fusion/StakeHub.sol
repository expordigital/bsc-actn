...
contract StakeHub is System, Initializable, Protectable {
    ...
    error InvalidUnjailAmount();

    error EnoughSelfBond();
    ...
    function initialize() external initializer onlyCoinbase onlyZeroGasPrice {
        ...
        minSelfDelegationBNB = 210_000 ether;
        minDelegationBNBChange = 1 ether;
        maxElectedValidators = 100;
        unbondPeriod = 7 days;
        redelegateFeeRate = 2;
        downtimeSlashAmount = 1050 ether;
     ...
     */
    function unjail(address operatorAddress) external payable whenNotPaused notInBlackList validatorExist(operatorAddress) {
        Validator storage valInfo = _validators[operatorAddress];
        ...
        if (msg.value < 21 ether) revert InvalidUnjailAmount();
